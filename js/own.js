          ...
          var tag = document.createElement('script');
                ...
                firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);
                  ...
                  function closeSideBar() {
                          ...
                          $('#split-bar').css("margin-right", -250);
...
//                              return 0;
//                          if ( parameterName == 'cat' )
//                              return 0;
//                      }
//                  }
//                  $('#selOrder').val(findGetParameter('sort'));
//                  $('#selCat').val(findGetParameter('cat'));
          ...
          $('div[class="youtube"]').each(function() {
              //to show video in modal:
                              ...
                              $('#videoInfo-modal'+ytID).on('hide.bs.modal', function () {
                                  console.log(player['player'+ytID].a);
              ...
              //alert(this.getBoundingClientRect().left+window.scrollX);
              //alert($(window).width());
              var tipAlignmentAt = 'right center';
              var tipAlignmentMy = 'left center';
              //alert((this.getBoundingClientRect().left+window.scrollX)*2 );
              //alert($(window).width());

              if ((this.getBoundingClientRect().left+window.scrollX) * 2 > $(window).width() ){
