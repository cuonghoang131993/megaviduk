...
<body id="page-top">
    ...
    <div class="container-fluid" style="padding-top:90px; text-align: justify;font-family: 'Open Sans', 'Helvetica Neue', Arial, sans-serif;">
        ...
        <h4>16. Data protection provisions about the application and use of Google Remarketing</h4>
        ...
        <h4>17. Data protection provisions about the application and use of Google+</h4>
        ...
        <h4>20. Data protection provisions about the application and use of Shariff</h4>
        ...
        <h4>25. Legal basis for the processing </h4>
        <p>
        ...
        <h4>26. The legitimate interests pursued by the controller or by a third party</h4>
        <p>Where the processing of personal data is based on Article 6(1) lit. f GDPR our legitimate interest is to carry out our business in favor of the well-being of all our employees and the shareholders.</p>

        <h4>27. Period for which the personal data will be stored</h4>
        <p>The criteria used to determine the period of storage of personal data is the respective statutory retention period. After expiration of that period, the corresponding data is routinely deleted, as long as it is no longer necessary for the fulfillment of the contract or the initiation of a contract.</p>

        <h4>28. Provision of personal data as statutory or contractual requirement; Requirement necessary to enter into a contract; Obligation of the data subject to provide the personal data; possible consequences of failure to provide such data </h4>
        <p>
        ...
        <h4>29. Existence of automated decision-making</h4>
