...
<div class="card-success text-center container" >
    ...
    <div class="row btnrow">
            <div class="col-md-6 col-12">
              <a href="index.php" style="margin-bottom:1em;" class="btn btn-primary btn-default">Home</a>
            </div>
            <div class="col-md-6 col-12">
                <a href="videos.php" style="margin-bottom:1em;" class="btn btn-primary btn-default">Video Library</a>
            </div>
</div>
</div>
  </div>
