<?php
    ...
    if ($userLoggedIn) {
        header('Location: licenseeinfo.php');
        exit();
    }
...
<head>
    ...
    <title>Sign In / Up - Secure Checkout | MegaVid</title>
    ...
    <style>
        .login-form[_ngcontent-xtr-c38] {
            max-width: 300px
        }
    </style>
    <style>
        .mailVal[_ngcontent-xtr-c36] {
            font-size: xx-large;
            text-align: center;
            margin: 5px;
...
<body id="page-top" style="background-color:#EAE9E9;">
    <div style="min-height:100%;">
        <div class="clear-top checkoutAllPAge">
            <style>
                .checkoutNavLogo {
                    padding-left: 15px;
                    height: 55px;
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="card-body" align="justify">
                                ...
                                <br><br>
                                If you are unsure about which rights you have already granted in the past, please contact us <u><a data-toggle="modal" data-dismiss="modal" data-target=".contact-modal" style="cursor: pointer;">here</a></u> or at <a href="mailto:info@megavid.com">info@megavid.com</a> and ask for assistance before submitting your video.
                            </div>
                        </div>
                    </div>
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div id="collapseSix" class="collapse" role="tabpanel" aria-labelledby="headingSix" data-parent="#accordion">
                            <div class="card-body" align="justify">
                                ...
                                <br><br>
                                <em>© Your Name / MegaVid </em>|<em> To license this video, visit <a href="https://megavid.com/videos">www.megavid.com/videos</a> or email <a href="mailto:licensing@megavid.com">licensing@megavid.com</a></em>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive" data-parent="#accordion">
                            <div class="card-body" align="justify">
                                We recommend to forward such message to <a href="mailto:licensing@megavid.com">licensing@megavid.com</a> and to send the following passage as reply additionally:
                                <br><br>
                                <em>Thank you for your message. Please visit <a href="https://megavid.com/videos">www.megavid.com/videos</a> or email <a href="mailto:licensing@megavid.com">licensing@megavid.com</a> to license / use this video. Thank you!</em>
                            </div>
                        </div>
                    </div>
                </div>
