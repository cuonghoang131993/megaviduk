              ...
              <div class="carousel-item active">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=vFTD0rqL5Z0">
                      <div class="youtube" data-embed="vFTD0rqL5Z0">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">06:09</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=vFTD0rqL5Z0">Uncut and Unseen: Greenland Tsunami (First Wave to Largest Wave in 6 mins.)</a>
                    </h4>
                    <input type="hidden" value="141.45" name="vFTD0rqL5Z0">
                    <a class="btn btn-default  orange" id="btn-vFTD0rqL5Z0" href="./footage.php?v=vFTD0rqL5Z0" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=16bAhJSL2-o">
                      <div class="youtube" data-embed="16bAhJSL2-o">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">01:50</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=16bAhJSL2-o">MEGA-TSUNAMI caused by LANDSLIDE devastates village - Camera 1 | Greenland, Nuugaatsiaq</a>
                    </h4>
                    <input type="hidden" value="169.74" name="16bAhJSL2-o">
                    <a class="btn btn-default  orange" id="btn-16bAhJSL2-o" href="./footage.php?v=16bAhJSL2-o" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=FlUsnc2KxiM">
                      <div class="youtube" data-embed="FlUsnc2KxiM">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">02:14</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=FlUsnc2KxiM">GREENLAND TSUNAMI Hits Village Caught On Camera - Camera 2 (Multiple Clips)</a>
                    </h4>
                    <input type="hidden" value="162.36" name="FlUsnc2KxiM">
                    <a class="btn btn-default  orange" id="btn-FlUsnc2KxiM" href="./footage.php?v=FlUsnc2KxiM" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=dlvm-FNgnUU">
                      <div class="youtube" data-embed="dlvm-FNgnUU">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">03:08</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=dlvm-FNgnUU">HORROR FLOOD: River Devastates City After Massive Rainfalls In Turkey</a>
                    </h4>
                    <input type="hidden" value="141.45" name="dlvm-FNgnUU">
                    <a class="btn btn-default  orange" id="btn-dlvm-FNgnUU" href="./footage.php?v=dlvm-FNgnUU" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=5Eq0MjUU1pM">
                      <div class="youtube" data-embed="5Eq0MjUU1pM">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">00:32</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=5Eq0MjUU1pM">Crazy Floods Destroying Homes and Businesses in Bozkurt, Turkey</a>
                    </h4>
                    <input type="hidden" value="126.50" name="5Eq0MjUU1pM">
                    <a class="btn btn-default  orange" id="btn-5Eq0MjUU1pM" href="./footage.php?v=5Eq0MjUU1pM" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=hVJg5ev1viA">
                      <div class="youtube" data-embed="hVJg5ev1viA">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">02:36</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=hVJg5ev1viA">Massive Landslide Destroys Homes in Istanbul</a>
                    </h4>
                    <input type="hidden" value="126.50" name="hVJg5ev1viA">
                    <a class="btn btn-default  orange" id="btn-hVJg5ev1viA" href="./footage.php?v=hVJg5ev1viA" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=wmi-tcrqP3o">
                      <div class="youtube" data-embed="wmi-tcrqP3o">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">05:35</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=wmi-tcrqP3o">Ganges River Erosion: Locals See As Their Whole Village Is Being Swallowed Up</a>
                    </h4>
                    <input type="hidden" value="126.50" name="wmi-tcrqP3o">
                    <a class="btn btn-default  orange" id="btn-wmi-tcrqP3o" href="./footage.php?v=wmi-tcrqP3o" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=-onwighzPDo">
                      <div class="youtube" data-embed="-onwighzPDo">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">02:08</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=-onwighzPDo">Ganges River Erosion: Locals Attempting to Protect Their Village From Flood</a>
                    </h4>
                    <input type="hidden" value="126.50" name="-onwighzPDo">
                    <a class="btn btn-default  orange" id="btn--onwighzPDo" href="./footage.php?v=-onwighzPDo" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=0gQ1z6Oztsw">
                      <div class="youtube" data-embed="0gQ1z6Oztsw">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">01:01</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=0gQ1z6Oztsw">AFTERMATH: The Result of the Massive Floods that Hit Bozkurt, Turkey</a>
                    </h4>
                    <input type="hidden" value="126.50" name="0gQ1z6Oztsw">
                    <a class="btn btn-default  orange" id="btn-0gQ1z6Oztsw" href="./footage.php?v=0gQ1z6Oztsw" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=DRG8kCFhLHk">
                      <div class="youtube" data-embed="DRG8kCFhLHk">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">06:57</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=DRG8kCFhLHk">Microburst Comes Out Of Nowhere And Blows Off A Rooftop In Germany</a>
                    </h4>
                    <input type="hidden" value="126.50" name="DRG8kCFhLHk">
                    <a class="btn btn-default  orange" id="btn-DRG8kCFhLHk" href="./footage.php?v=DRG8kCFhLHk" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=LxfwXDUDbbo">
                      <div class="youtube" data-embed="LxfwXDUDbbo">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">00:29</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=LxfwXDUDbbo">Destructive Tornado Demolishes Locals’ Homes in Moravská Nová Ves</a>
                    </h4>
                    <input type="hidden" value="126.50" name="LxfwXDUDbbo">
                    <a class="btn btn-default  orange" id="btn-LxfwXDUDbbo" href="./footage.php?v=LxfwXDUDbbo" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=aftWRoCb1d0">
                      <div class="youtube" data-embed="aftWRoCb1d0">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">06:22</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=aftWRoCb1d0">Ganges River Erosion: Local's Home Collapses And Lands In the River</a>
                    </h4>
                    <input type="hidden" value="126.50" name="aftWRoCb1d0">
                    <a class="btn btn-default  orange" id="btn-aftWRoCb1d0" href="./footage.php?v=aftWRoCb1d0" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=o4aqo_llcMc">
                      <div class="youtube" data-embed="o4aqo_llcMc">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">07:07</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=o4aqo_llcMc">3 Days of Continuous Landslides at Pentreath Beach</a>
                    </h4>
                    <input type="hidden" value="126.50" name="o4aqo_llcMc">
                    <a class="btn btn-default  orange" id="btn-o4aqo_llcMc" href="./footage.php?v=o4aqo_llcMc" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=oejE217H_PM">
                      <div class="youtube" data-embed="oejE217H_PM">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">06:56</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=oejE217H_PM">Ganges River Erosion: Abandoned Home Crashes Into The River After Relentless Flood</a>
                    </h4>
                    <input type="hidden" value="126.50" name="oejE217H_PM">
                    <a class="btn btn-default  orange" id="btn-oejE217H_PM" href="./footage.php?v=oejE217H_PM" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=HxIMs7DlDEY">
                      <div class="youtube" data-embed="HxIMs7DlDEY">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">06:34</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=HxIMs7DlDEY">Ganges River Erosion: Local Mosque Is Eaten Up By The River As The Ground Around It Crumbles</a>
                    </h4>
                    <input type="hidden" value="126.50" name="HxIMs7DlDEY">
                    <a class="btn btn-default  orange" id="btn-HxIMs7DlDEY" href="./footage.php?v=HxIMs7DlDEY" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=DisUyaUketk">
                      <div class="youtube" data-embed="DisUyaUketk">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">03:17</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=DisUyaUketk">Giant Rolling Iceberg Creates a Tsunami-like Wave</a>
                    </h4>
                    <input type="hidden" value="108.24" name="DisUyaUketk">
                    <a class="btn btn-default  orange" id="btn-DisUyaUketk" href="./footage.php?v=DisUyaUketk" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=gygbEtu5u6w">
                      <div class="youtube" data-embed="gygbEtu5u6w">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">09:58</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=gygbEtu5u6w">MASSIVE Debris Flow Builds Up Within Minutes Near Home (CCTV)</a>
                    </h4>
                    <input type="hidden" value="126.50" name="gygbEtu5u6w">
                    <a class="btn btn-default  orange" id="btn-gygbEtu5u6w" href="./footage.php?v=gygbEtu5u6w" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=i6QeZtMyjso">
                      <div class="youtube" data-embed="i6QeZtMyjso">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">00:53</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=i6QeZtMyjso">Unexpected 'Rogue Wave' Nearly Smashes Boat Near The Coast of Mexico</a>
                    </h4>
                    <input type="hidden" value="126.50" name="i6QeZtMyjso">
                    <a class="btn btn-default  orange" id="btn-i6QeZtMyjso" href="./footage.php?v=i6QeZtMyjso" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=QgjQUPDAx_g">
                      <div class="youtube" data-embed="QgjQUPDAx_g">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">05:18</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=QgjQUPDAx_g">Rapid Flash Flood Cause Parked Vehicles To Flee!</a>
                    </h4>
                    <input type="hidden" value="126.50" name="QgjQUPDAx_g">
                    <a class="btn btn-default  orange" id="btn-QgjQUPDAx_g" href="./footage.php?v=QgjQUPDAx_g" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=GNsdpbBei2A">
                      <div class="youtube" data-embed="GNsdpbBei2A">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">02:37</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=GNsdpbBei2A">Mini-Tsunami Waves Caused By A Large Glacier Calving Hit A Small Harbor In Greenland</a>
                    </h4>
                    <input type="hidden" value="120.75" name="GNsdpbBei2A">
                    <a class="btn btn-default  orange" id="btn-GNsdpbBei2A" href="./footage.php?v=GNsdpbBei2A" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=sCa9payNpSo">
                      <div class="youtube" data-embed="sCa9payNpSo">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">01:37</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=sCa9payNpSo">Locals Gather As Flash Flooding Happens In Wadi Masah </a>
                    </h4>
                    <input type="hidden" value="105.00" name="sCa9payNpSo">
                    <a class="btn btn-default  orange" id="btn-sCa9payNpSo" href="./footage.php?v=sCa9payNpSo" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=0STxbYuXNI4">
                    ...
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=0STxbYuXNI4">Massive High Tide Wave Almost Hits Bystanders Near a Pier in Kolkata</a>
                    </h4>
                    <input type="hidden" value="89.25" name="0STxbYuXNI4">
                    <a class="btn btn-default  orange" id="btn-0STxbYuXNI4" href="./footage.php?v=0STxbYuXNI4" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=RVwLHX6lgzQ">
                      <div class="youtube" data-embed="RVwLHX6lgzQ">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">02:38</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=RVwLHX6lgzQ">INCREDIBLE COLLAPSE TRIGGERED BY GLACIER CALVING | South America, Chile</a>
                    </h4>
                    <input type="hidden" value="169.74" name="RVwLHX6lgzQ">
                    <a class="btn btn-default  orange" id="btn-RVwLHX6lgzQ" href="./footage.php?v=RVwLHX6lgzQ" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=pKd0PCI6Sx4">
                      <div class="youtube" data-embed="pKd0PCI6Sx4">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">06:36</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=pKd0PCI6Sx4">'TSUNAMI-LIKE WAVES' Hit Village in Indonesia (Tidal Bore) | Kampar River (Sumatra)</a>
                    </h4>
                    <input type="hidden" value="141.45" name="pKd0PCI6Sx4">
                    <a class="btn btn-default  orange" id="btn-pKd0PCI6Sx4" href="./footage.php?v=pKd0PCI6Sx4" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=QEWENb7eNBw">
                      <div class="youtube" data-embed="QEWENb7eNBw">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">01:39</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=QEWENb7eNBw">FLASH FLOOD: Drivers TRAPPED In Traffic Fear For Their Lives!</a>
                    </h4>
                    <input type="hidden" value="141.45" name="QEWENb7eNBw">
                    <a class="btn btn-default  orange" id="btn-QEWENb7eNBw" href="./footage.php?v=QEWENb7eNBw" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=M3NxW4hL-tM">
                      <div class="youtube" data-embed="M3NxW4hL-tM">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">01:44</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=M3NxW4hL-tM">Ship in Storm | Multiple MONSTER WAVES Hit Rescue Vessel in the North Sea! [See Until End]</a>
                    </h4>
                    <input type="hidden" value="141.45" name="M3NxW4hL-tM">
                    <a class="btn btn-default  orange" id="btn-M3NxW4hL-tM" href="./footage.php?v=M3NxW4hL-tM" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=T2MtSjsVHE8">
                      <div class="youtube" data-embed="T2MtSjsVHE8">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">02:17</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=T2MtSjsVHE8">GIANT Iceberg 'Shooter' Triggered By Massive Glacier Calving [4K]</a>
                    </h4>
                    <input type="hidden" value="162.36" name="T2MtSjsVHE8">
                    <a class="btn btn-default  orange" id="btn-T2MtSjsVHE8" href="./footage.php?v=T2MtSjsVHE8" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=DUbDwek6rAQ">
                      <div class="youtube" data-embed="DUbDwek6rAQ">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">00:44</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=DUbDwek6rAQ">Ship in Storm | MONSTER WAVE DESTROYS Oil Tanker's Bridge in Baltic Sea!</a>
                    </h4>
                    <input type="hidden" value="141.45" name="DUbDwek6rAQ">
                    <a class="btn btn-default  orange" id="btn-DUbDwek6rAQ" href="./footage.php?v=DUbDwek6rAQ" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=Jno2DawFSfg">
                      <div class="youtube" data-embed="Jno2DawFSfg">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">00:59</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=Jno2DawFSfg">Fishing Trawler Tossed Around Like a Toy in Rough Seas and Massive Waves [4K]</a>
                    </h4>
                    <input type="hidden" value="169.74" name="Jno2DawFSfg">
                    <a class="btn btn-default  orange" id="btn-Jno2DawFSfg" href="./footage.php?v=Jno2DawFSfg" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
              ...
              <div class="carousel-item">
                <div class="card d-block">
                  <div class="card-body" style="padding-top:4px;">
                    ...
                    <a href="./footage.php?v=4u06QM8pX7E">
                      <div class="youtube" data-embed="4u06QM8pX7E">
                        <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;">
                          <font color="white">00:50</font>
                        </div>
                      </div>
                    </a>
                    <h4 class="card-title carousselItemTitle">
                      <a class="videoInfoLink" <a href="./footage.php?v=4u06QM8pX7E">Ship in Storm: Oil Tanker Caught In Horrible Storm In the North Sea</a>
                    </h4>
                    <input type="hidden" value="141.45" name="4u06QM8pX7E">
                    <a class="btn btn-default  orange" id="btn-4u06QM8pX7E" href="./footage.php?v=4u06QM8pX7E" style="width:100%;    white-space: normal;"><i class="fa fa-arrow-circle-right"></i> REQUEST LICENSE</a>
                  </div>
