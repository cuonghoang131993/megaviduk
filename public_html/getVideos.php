      ...
      foreach ($response as $item) {
        echo '<div class="col-xl-3 col-lg-4 col-md-6 mb-4">
              <div class="card " >
                ...
                <a id="videoElementLink-' . $item->id . '"  href="./footage?v=' . $item->id . '">
                ...
                <div style="position: absolute;bottom: 0px;right: 0px; padding: 2px; margin:5px;z-index:50;background-color:black;"><font color="white">02:38</font></div>
                  ...
                  <h4 class="card-title videoElementTitle">
                    <a style="color:rgb(0, 87, 255) !important;" id="titleLink-' . $item->id . '" class="videoInfoLink" href="./footage?v=' . $item->id . '">' . $item->title . '</a>
                  </h4>
                  <p class="card-text">
                      <div style="height:3em;overflow:hidden;text-overflow: ellipsis;">
                      <p align="justify">' . $item->description . '<a class="videoInfoLink" id="videoMoreLink-' . $item->id . '" href="./footage?v=' . $item->id . '">...[more]</a></p>
                      </div>
                  </p>

                <input type="hidden" value="169.74" name="' . $item->id . '">
                <a class="btn btn-default sr-button orange" id="btn-' . $item->id . '" href="./footage?v=' . $item->id . '" style="width:100%;    white-space: normal;" ><i class="fa fa-arrow-circle-right" ></i> REQUEST LICENSE</a>
                </div>
