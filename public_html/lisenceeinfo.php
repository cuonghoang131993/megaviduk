            ...
            <form class="form-signin" id="licenseeInfoForm" action="paymentmethod.php" method="post" style="margin-top:2rem;margin-bottom:1rem;">
              ...
              <div class="row">
                <div class="col-12 col-lg-4" style="height:94px;">
                  <label for="inputCountry">Country<font color="#F05F40">*</font></label>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                  <label for="inputCity">City<font color="#F05F40">*</font></label>
                  <input type="text" id="inputCity" name="inputCity" class="form-control" value="Ho Chi Minh" required="">
                </div>
                <div class="col-12 col-sm-6 col-lg-4">
                  <label for="inputZip">ZIP / Postal Code<font color="#F05F40">*</font></label>
                  <input type="text" id="inputZip" name="inputZip" class="form-control" value="700000" required="">
                </div>
              </div>
              <label for="inputStreet">Street Address<font color="#F05F40">*</font></label>
              ...
              <div id="billingAdd" style="display:none; margin-top:2rem;">
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-sm-6 col-lg-4">
                    <label for="inputCity">City<font color="#F05F40">*</font></label>
                    <input type="text" id="inputCityBilling" name="inputCityBilling" class="form-control" value="Ho Chi Minh">
                  </div>
                  <div class="col-12 col-sm-6 col-lg-4">
                    <label for="inputZip">ZIP / Postal Code<font color="#F05F40">*</font></label>
                    <input type="text" id="inputZipBilling" name="inputZipBilling" class="form-control" value="700000">
                  </div>
                </div>
                <label for="inputStreet">Street Address<font color="#F05F40">*</font></label>
              ...
              <p style="margin-bottom: 0;margin-top: 1em;">
                <font color="#F05F40">*</font> REQUIRED
              </p>
            </form>
          </div>
