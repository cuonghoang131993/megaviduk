...
<option value="5">Crazy</option><option value="27">Ships</option><option value="1">Accidents &amp; Fails</option><option value="6">Funny</option><option value="24">Fails (Funny, Unexpected & Expensive)</option><option value="32">Other Viral (Somehow!)</option><option value="21">Extreme Moments Caught On Camera</option><option value="8">Weather</option><option value="25">Heavy Equipment</option><option value="6">Funny</option><option value="3">Animals</option><option value="32">Other Viral (Somehow!)</option><option value="4">Cute</option><option value="30">Other Viral (Somehow!)</option><option value="11">Aviation</option><option value="13">Close Calls</option><option value="14">Crashes</option><option value="7">Sports</option><option value="8">Weather</option><option value="22">Extreme Weather</option><option value="9">Wins, Tricks &amp; Stunts</option><option value="2">Adventure</option><option value="23">Natural Disasters</option><option value="16">Climate</option><option value="17">Dashcam</option><option value="18">Demolition</option><option value="12">CCTV</option><option value="10">Other</option>
    ...
    loadVideos();
        ...
        function loadVideos(){
            ...
            $.ajax({
                              url: 'getVideos.php',
                              type: 'post',
                              data: {cat:"9", minIndex:minIndex,maxIndex:videosPerPage},
                              beforeSend:function(){
                              },
